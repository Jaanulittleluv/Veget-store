...
<nav>
    ...
    <form action="./script.php" method="post">
      <h2 class="text-3xl text-align:center text-slate-600"><b>Herbal Plants</b></h2>
    <div class="input-field">
      ...
      <div class="select">
   <select name="herbalplants" id="format">
      <option selected disabled>Choose your Herbal Plant</option>
