...
<head>
    ...
    <title>Herbalplants Market</title>
...
<nav>
    ...
    <form action="./script.php" method="post">
      <h2 class="text-3xl text-align:center text-slate-600"><b>Leafy Vegetables</b></h2>
    <div class="input-field">
      ...
      <div class="select">
   <select name="leafyvegetables" id="format">
      <option selected disabled>Choose your Leaf Vegetable</option>
      <option>spinach</option>
          <option>Broccoli</option>
          <option>Asparagus</option>
          <option>Iceberg</option>
          <option>Leak</option>
          <option>Grass pea leaves</option>
          <option>Spring onion</option>
          <option>Curry Leaves</option>
